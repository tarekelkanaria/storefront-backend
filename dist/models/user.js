...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new Error("Can't get users. Error: ".concat(err_1));
                    case 5:
                        connection.release();
                        return [7 /*endfinally*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_2 = _a.sent();
                        throw new Error("Can't find user ".concat(id, ". Error: ").concat(err_2));
                    case 5:
                        connection.release();
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        hash = bcrypt_1["default"].hashSync(user.password_digest + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, connection.query(sql, [
                                user.first_name,
                                user.last_name,
                                hash,
                    ...
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("Can't add new user ".concat(user.first_name, " ").concat(user.last_name, ". ").concat(err_3));
                    case 5:
                        connection.release();
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/];
    ...
    UserStore.prototype.update = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, hash, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                    ...
                    case 2:
                        _a.trys.push([2, 4, 5, 6]);
                        sql = "UPDATE users SET first_name=$1, last_name=$2, password_digest=$3 WHERE id=$4 RETURNING *;";
                        hash = bcrypt_1["default"].hashSync(user.password_digest + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, connection.query(sql, [
                                user.first_name,
                                user.last_name,
                    ...
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("Can't update user ".concat(user.first_name, ". Error: ").concat(err_4));
                    case 5:
                        connection.release();
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_5 = _a.sent();
                        throw new Error("Can't remove user ".concat(id, ". Error: ").concat(err_5));
                    case 5:
                        connection.release();
                        return [7 /*endfinally*/];
                    case 6: return [2 /*return*/];
