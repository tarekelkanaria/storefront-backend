...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authenticate(user.first_name, user.password_digest)];
            case 2:
                verfied = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: verfied }, tokenSecret);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                err_2 = _a.sent();
                res.status(401);
                res.json("".concat(err_2, " ").concat(user));
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_3 = _a.sent();
                res.status(400);
                res.json("".concat(err_3, " ").concat(user));
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
